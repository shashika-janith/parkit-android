...
class ProviderRepositoryImpl @Inject constructor(private val pagingSourceFactory: PagingSourceFactory) :
    IProviderRepository {
    ...
    override fun getProviderById(id: Int): ProviderResponseDto {
